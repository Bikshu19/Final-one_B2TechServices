...
export default function Dashboard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch("https://final-one-b2techservices.onrender.com/news/flashnews", {
          headers,
        });
        if (res.ok) {
  ...
  const saveFlashnews = async () => {
    try {
      await fetch("https://final-one-b2techservices.onrender.com/news/flashnews", {
        method: "PUT",
